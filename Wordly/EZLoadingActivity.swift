...
public struct EZLoadingActivity {
    ...
    public struct Settings {
       // public static var BackgroundColor = UIColor(red: 227/255, green: 232/255, blue: 235/255, alpha: 0.4)
       public static var BackgroundColor = UIColor(red: 250/255, green: 250/255, blue: 250/255, alpha: 1)
       ...
       // public static var TextColor = UIColor(red: 225/255, green: 225/255, blue: 225/255, alpha: 1.0)
       //  public static var FontName = "HelveticaNeue-Light"
       public static var FontName = "Zapf Dingbats"
    ...
    private class LoadingActivity: UIView {
        ...
        convenience init(text: String, disableUI: Bool) {
            ...
            textLabel.font =  Settings.isIpad ? UIFont(name: Settings.FontName, size: 33) : UIFont(name: Settings.FontName, size: 21)
